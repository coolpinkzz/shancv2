    ...
    >
      <Container>
        ...
        <Image width="20%" src="logo-with-name.png" fontSize="3xl" fontWeight="semibold" color="text" />
          <NavMenu
            name={navName}
            gap={[0, 8, 14]}
            ml={["auto", "auto"]}
...
export const Branding = () => {
  ...
  return (
    <Container>
    <Image mt="5" width="15%"src="logo-with-name.png" fontSize="3xl" fontWeight="semibold" color="text" />
    </Container> 
